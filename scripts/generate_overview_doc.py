...
# Lancer simplement via :
# python generate_overview_doc.py
# Le fichier docs/codebase/overview.md sera automatiquement (ré)écrit.
#
# ====================================================================
...
OUTPUT_PATH = Path("docs/codebase/overview.md")

# Texte statique structuré avec la hiérarchie et les rôles, basé sur ton projet
overview_markdown = """\
...
# Sauvegarde dans le fichier Markdown
def save_overview_file():
